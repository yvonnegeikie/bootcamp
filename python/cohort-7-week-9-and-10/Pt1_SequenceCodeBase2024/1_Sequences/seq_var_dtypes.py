...
print(2-2)   # Modify to use a different operator
print(10+3*4-2)  # Make : Use a different number and/or operator
...
# Use text (format your output) in your addition, for example print("The answer to 2 x 3 =", 2 * 3)"
...
#Distinguish between declaration, initialisation, and assignment of variables 
# declare userName as a variable and initialise with value "amj" 
userName = "amj" # initialisation
userName = "psmith" # assignment or re-assignment

#AGE is a constant do not re-assign after initialisation
AGE = 21 
print("Initial age", AGE)
AGE = 23
print("Modify age", AGE)
